...
document.addEventListener('DOMContentLoaded', function () {
    const prefixToRemove = "I want to taste them all – Bundle -";

    function cleanBundleTitles() {
      const bundleTitles = document.querySelectorAll('.bndlr-product-title');

      bundleTitles.forEach(function(el) {
        if (el.textContent.includes(prefixToRemove)) {
          el.textContent = el.textContent.replace(prefixToRemove, '').trim();
        }
      });
    }
    ...
    // Also observe for dynamic bundle render
  ...
  document.addEventListener('DOMContentLoaded', function () {
    const prefixToRemove = "I want to taste all the cookies | Save 5% - ";
  ...
  document.addEventListener('DOMContentLoaded', function () {
    const prefixToRemove = "Power Biscuit Custom Box - ";
    ...
    document.addEventListener('DOMContentLoaded', function () {
    const prefixToRemove = "Power Cookie - ";
  ...
  document.addEventListener('DOMContentLoaded', function () {
    const prefixToRemove = "Perhaps the best protein powder  in the world! - ";
  ...
  document.addEventListener('DOMContentLoaded', function () {
    const prefixToRemove = "Standing order - ";
